 ...
 * limitations under the License.
 * ======================================================================== */
+function(t){"use strict";var e=function(i,o){this.options=t.extend({},e.DEFAULTS,o),this.$window=t(window).on("scroll.bs.affix.data-api",t.proxy(this.checkPosition,this)).on("click.bs.affix.data-api",t.proxy(this.checkPositionWithEventLoop,this)),this.$element=t(i),this.affixed=this.unpin=null,this.checkPosition()};e.RESET="affix affix-top affix-bottom",e.DEFAULTS={offset:0},e.prototype.checkPositionWithEventLoop=function(){setTimeout(t.proxy(this.checkPosition,this),1)},e.prototype.checkPosition=function(){if(this.$element.is(":visible")){var i=t(document).height(),o=this.$window.scrollTop(),n=this.$element.offset(),s=this.options.offset,a=s.top,r=s.bottom;"object"!=typeof s&&(r=a=s),"function"==typeof a&&(a=s.top()),"function"==typeof r&&(r=s.bottom());var l=null!=this.unpin&&o+this.unpin<=n.top?!1:null!=r&&n.top+this.$element.height()>=i-r?"bottom":null!=a&&a>=o?"top":!1;this.affixed!==l&&(this.unpin&&this.$element.css("top",""),this.affixed=l,this.unpin="bottom"==l?n.top-o:null,this.$element.removeClass(e.RESET).addClass("affix"+(l?"-"+l:"")),"bottom"==l&&this.$element.offset({top:document.body.offsetHeight-r-this.$element.height()}))}};var i=t.fn.affix;t.fn.affix=function(i){return this.each(function(){var o=t(this),n=o.data("bs.affix"),s="object"==typeof i&&i;n||o.data("bs.affix",n=new e(this,s)),"string"==typeof i&&n[i]()})},t.fn.affix.Constructor=e,t.fn.affix.noConflict=function(){return t.fn.affix=i,this},t(window).on("load",function(){t('[data-spy="affix"]').each(function(){var e=t(this),i=e.data();i.offset=i.offset||{},i.offsetBottom&&(i.offset.bottom=i.offsetBottom),i.offsetTop&&(i.offset.top=i.offsetTop),e.affix(i)})})}(jQuery);var github=function(){function t(t){return $("<div/>").text(t).html()}function e(e,i){var o=0,n="",s=$(e)[0];for(o=0;o<i.length;o++)n+='<a class="list-group-item" href="'+i[o].html_url+'"><h4 class="list-group-item-heading">'+i[o].name+"</h4><p>"+t(i[o].description||"")+"</p></a>";s.innerHTML=n}return{showRepos:function(t){$.ajax({url:"https://api.github.com/users/"+t.user+"/repos?sort=pushed&callback=?",dataType:"jsonp",error:function(){$(t.target+" li.loading").addClass("error").text("Error loading feed")},success:function(i){var o=[];if(i&&i.data){for(var n=0;n<i.data.length;n++)t.skip_forks&&i.data[n].fork||o.push(i.data[n]);t.count&&o.splice(t.count),e(t.target,o)}}})}}}();!function(t){var e=t.setTimeout,i=t.document,o=0;t.jXHR=function(){function n(){try{c.parentNode.removeChild(c)}catch(t){}}function s(){p=!1,h="",n(),c=null,l(0)}function a(t){try{d.onerror.call(d,t,h)}catch(e){throw new Error(t)}}function r(){this.readyState&&"complete"!==this.readyState&&"loaded"!==this.readyState||p||(this.onload=this.onreadystatechange=null,p=!0,4!==d.readyState&&a("Script failed to load ["+h+"]."),n())}function l(t,e){e=e||[],d.readyState=t,"function"==typeof d.onreadystatechange&&d.onreadystatechange.apply(d,e)}var h,p,c,d=null;return d={onerror:null,onreadystatechange:null,readyState:0,open:function(e,i){s(),internal_callback="cb"+o++,function(e){t.jXHR[e]=function(){try{l.call(d,4,arguments)}catch(i){d.readyState=-1,a("Script failed to run ["+h+"].")}t.jXHR[e]=null}}(internal_callback),h=i.replace(/=\?/,"=jXHR."+internal_callback),l(1)},send:function(){e(function(){c=i.createElement("script"),c.setAttribute("type","text/javascript"),c.onload=c.onreadystatechange=function(){r.call(c)},c.setAttribute("src",h),i.getElementsByTagName("head")[0].appendChild(c)},0),l(2)},setRequestHeader:function(){},getResponseHeader:function(){return""},getAllResponseHeaders:function(){return[]}},s(),d}}(window);